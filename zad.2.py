...
Library1 = Library("Tarnowskie Gory", "Miętowa", "17635",
                   "9:00  - 17:00", "123-456-789")
Library2 = Library("Wrocław", "Słoneczna", "57632", "10:00 -"
                   "18:00", "784-345-122")

employee1 = Employee("Kamil", "Lech", "2022-04-23", "1988-04-01",
                     "Łodź", "Lawendowa", "15677", "177-542-333")
employee2 = Employee("Justyna", "Marek", "2022-04-02", "1995-07-08",
                     "Warszawa", "3 Maja", "54321", "484-875-606")
employee3 = Employee("Amelia", "Podsiadło", "2021-09-23", "1982-09-07",
                     "Wrocław", "Lesna", "17645", "987-848-903")
